...
export default function HomePage() {
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', sans-serif" }} className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-lg mx-auto px-5 py-12">
        ...
        <div className="space-y-3">
          {members.map((member, i) => (
            <div
              ...
              className="bg-gray-900 border border-gray-800 rounded-2xl p-4 flex items-center gap-4 cursor-pointer hover:border-gray-600 hover:bg-gray-800 transition-all duration-200"
            >
              {/* Avatar */}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-1.5">
                  <span className="bg-gray-800 text-gray-400 text-xs px-2 py-0.5 rounded-full border border-gray-700">TI · T2C</span>
                  <span className="bg-gray-800 text-gray-400 text-xs px-2 py-0.5 rounded-full border border-gray-700">📍 {member.domicile}</span>
                </div>
              </div>

              {/* Arrow */}
              <div className="w-8 h-8 rounded-full border border-gray-700 flex items-center justify-center text-gray-500 flex-shrink-0">
                →
              </div>
            </div>
          ))}
        ...
        <div className="mt-12">
          ...
          <p className="text-center text-gray-700 text-xs">© 2026 · Kelompok 2 · Universitas Brawijaya</p>
        </div>
      </div>
    </div>
  );
